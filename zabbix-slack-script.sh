...
url='https://hooks.slack.com/services/T1U71PZGS/B6UAKM4BE/2AtutNnSU00Co'
username='Ansible'
...
curl -m 5 --data-urlencode "${payload}" $url -A 'zabbix-slack-script / https://github.com/lalkrishnak/zabbix-hub/zabbix-slack-script'